...
int LineParser::parse(vector<string> stringVector, int startIndex) {
    ...
    switch (command) {
        ...
        case OpenDataServer : {
            string port = util.shuntingYard(smallLexer.lexer(stringVector.at(1)), this->symbolTable);
            string herz = util.shuntingYard(smallLexer.lexer(stringVector.at(2)), this->symbolTable);
...
//            openServer.execute(stringVector.at(1), stringVector.at(2));
        ...
        case Connect : { //Is Complete.
            ConnectCommand connect(stringVector.at(1), util.shuntingYard(smallLexer.lexer(stringVector.at(2)), this->symbolTable), &this->dataSender);
...
//            indexJumpValue = varCommand.execute();
            ...
            if ((stringVector.at(2) == "=") && (stringVector.at(3) == "bind")) {
                ...
                string expressionAfterEquation = util.shuntingYard(smallLexer.lexer(stringVector.at(3)), this->symbolTable);
        ...
        case Equal : {
            ...
            if (this->dataReaderServer.isInBindMap(stringVector.at(0))) {  //SCAT like it is not there.. seg?
                ...
                symbolTable.set(address,
                                 stod(this->util.shuntingYard(this->smallLexer.lexer(stringVector.at(2)), this->symbolTable)));
                ...
                symbolTable.set(stringVector.at(0), stod(this->
                        util.shuntingYard(this->smallLexer.lexer(stringVector.at(2)), this->symbolTable)));
            }
            indexJumpValue = 3;
            break;
        }
        ...
        case Print : {
            ...
            else if (stringVector.at(1).at(0) == '-' || stringVector.at(1).at(0) == '(' || isdigit(stringVector.at(1).at(0))){
                cout << "Detected a math operation to print\n";
                printString = util.shuntingYard(smallLexer.lexer(stringVector.at(1)), this->symbolTable);
            }
        ...
        case Sleep : {
            ...
            SleepCommand sleepCommand(stod(this->util.shuntingYard(stringExp, this->symbolTable)));
